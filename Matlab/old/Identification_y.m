...
subplot(323), plot(time, output_y, time, input), title('Position y'), xlabel('time [s]'), ylabel('position [m]'), legend('output','input')
...
input_f = fft(input);
output_y_f = fft(output_x);
velocity_x_f = fft(velocity_x);

FRF = output_y_f./input_f;
...
% % output filtering
% output_y_filt = filter(B, A, output_y);
% 
...
% subplot(212),plot(time, output_y, time, output_y_filt),title('pos_{y,filt}')
...
% 
% y1 = output_y(3:end);
% Phi1 = [-output_y(2:end-1), -output_y(1:end-2), input(3:end), input(2:end-1), input(1:end-2)];
% theta1 = Phi1\y1;
% 
...
% % theta = [a1 a0 b2 b1 b0]
% 
% y2 = output_y_filt(3:end);
% Phi2 = [-output_y_filt(2:end-1), -output_y_filt(1:end-2), input_filt(3:end), input_filt(2:end-1), input_filt(1:end-2)];
% theta2 = Phi2\y2;
% 
...
% hold on
% plot(t, output_y,'g')
% plot(t, output_y_filt)
% plot(t,x2)
% legend('pos_{y,meas}', 'pos_{y,filt}', 'pos_{y,sim}')
...
% 
% y3 = output_y(4:end);
% Phi3 = [-output_y(3:end-1), -output_y(2:end-2), -output_y(1:end-3), input(4:end), input(3:end-1), input(2:end-2), input(1:end-3)];
% theta3 = Phi3\y3;
% 
...
% % theta = [a2 a1 a0 b3 b2 b1 b0]
% 
% y4 = output_y_filt(4:end);
% Phi4 = [-output_y_filt(3:end-1), -output_y_filt(2:end-2), -output_y_filt(1:end-3), input_filt(4:end), input_filt(3:end-1), input_filt(2:end-2), input_filt(1:end-3)];
% theta4 = Phi4\y4;
% 
...
% 
% y5 = output_y(4:end);
% Phi5 = [-output_y(3:end-1), -output_y(2:end-2), -output_y(1:end-3), input(4:end), input(3:end-1), input(2:end-2), input(1:end-3)];
% theta5 = Phi5\y5;
% 
...
y6 = output_y_filt(4:end);
% Phi6 = [-output_y_filt(3:end-1), -output_y_filt(2:end-2), -output_y_filt(1:end-3), input_filt(3:end-1), input_filt(2:end-2), input_filt(1:end-3)];
Phi6 = [-output_y_filt(3:end-1), -output_y_filt(2:end-2), -output_y_filt(1:end-3), input_filt(1:end-3)];
theta6 = Phi6\y6;
...
% 
% y7 = output_y_filt(5:end);
% Phi7 = [-output_y_filt(4:end-1), -output_y_filt(3:end-2), -output_y_filt(2:end-3), -output_y_filt(1:end-4), input_filt(4:end-1), input_filt(3:end-2), input_filt(2:end-3), input_filt(1:end-4)];
% theta7 = Phi7\y7;
% 
...
%% Save result
% save('YSignals_50Hz','input','output_y','x6')
